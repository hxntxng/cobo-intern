...
def c_deposit(w3, acct, val):
    ...
    data =  [Web3.toBytes(hexstr='0x00000000000000000000000046e6b214b524310239732d51387075e0e70970bf0000000000000000000000000f25496cf87be88c0a352d822c4ba92479f536010000000000000000000000000000000000000000000000000001c6bf52634000')]
    base_bulk_contract.invoke(deposit_action, data, {"from": acct, "value": acct.balance()/2})
    # print(base_bulk_contract_txn.info())
