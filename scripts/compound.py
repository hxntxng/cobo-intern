...
def c_deposit(w3, acct, val):
    ...
    cWETH_contract = w3.eth.contract(address = cWETH_address, abi = cWETH_abi)
    base_bulk_address = '0x78D0677032A35c63D142a48A2037048871212a8C'
    allowed = True
    allow_cWETH_txn = cWETH_contract.functions.allow(base_bulk_address, allowed).build_transaction({'gas': 200000, 'gasPrice': w3.toWei('0.01', 'gwei'), 'nonce': nonce,})
