...
def c_deposit(acct, val):
    ...
    invoke_bulker_txn = base_bulk_abi.functions.invoke(deposit_action, data).build_transaction({'chainId': 8453, 'gas': 200000, 'gasPrice': w3.toWei('0.01', 'gwei'), 'nonce': nonce,})
