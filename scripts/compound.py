...
def swap_eth_for_token(acct, val):
    ...
    approve_token(cbeth_token_contract, UNISWAP_ROUTER_ADDRESS, unlim, acct)
...
def deposit_collateral(acct, val):
    ...
    cbeth_token_abi = abi.alienbase_cbeth_token_abi
    cbeth_token_contract = Contract.from_abi("UpgradeableOptimismMintableERC20", address = CBETH_TOKEN_ADDRESS, abi = cbeth_token_abi)
    swap_eth_for_token(acct, acct.balance()/5)
