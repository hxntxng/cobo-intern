...
def deposit(acct, val):
    ...
    approve_contract_abi = abi.alienbase_approve_abi
    ...
    add_contract_abi = abi.alienbase_add_eth_abi
    ...
    approve_spec_contract_abi = abi.alienbase_approve_spec_abi
    ...
    deposit_contract_abi = abi.alienbase_deposit_abi
...
def withdraw(acct):
    ...
    withdraw_contract_abi = abi.alienbase_deposit_abi
    withdraw_contract = w3.eth.contract(address = withdraw_contract_address, abi = withdraw_contract_abi)
    val = withdraw_contract.functions.userInfo(6, acct).call()[0]
